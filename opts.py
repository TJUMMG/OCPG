...
def get_args_parser():
    ...
    parser.add_argument('--freeze_video_encoder', action='store_true') # default: False
    ...
    parser.add_argument('--proj_loss_coef', default=5, type=float)
    parser.add_argument('--lst_loss_coef', default=2, type=float)
    ...
    parser.add_argument(
        ...
        choices=["full", "point", "box"],
    )
    parser.add_argument('--with_flow', action='store_true')
    ...
    parser.add_argument('--ytvos_path', type=str, default='/media/HardDisk_B/Users/wx/wwk_files/datasets/referring_video_segmentation/Refer-YouTube-VOS')
    parser.add_argument('--davis_path', type=str, default='/media/HardDisk_B/datasets/referring_video_segmentation/ref-davis')
    parser.add_argument('--a2d_path', type=str, default='/media/HardDisk_B/Users/wx/wwk_files/datasets/referring_video_segmentation/a2d-sentences')
    parser.add_argument('--jhmdb_path', type=str, default='/media/HardDisk_B/Users/wx/wwk_files/datasets/referring_video_segmentation/jhmdb_sentences')
